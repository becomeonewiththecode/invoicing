...
| [`deployment/`](deployment/README.md) | Deployment guides; Compose files; prod uses Docker Hub **`maxwayne/invoice-*:1.0`**; local builds tag **`invoice-*:1.0`** (see [deployment/README.md](deployment/README.md)) |
